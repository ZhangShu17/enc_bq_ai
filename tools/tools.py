...
# 蓝方战车侦查路线
blue_car_detect_path = [
							[1926, 1925, 1825, 1924, 2024, 2025, 2026, 1926],
							[1926, 1827, 1727, 1628, 1727, 1827, 1926]
						]
# 蓝方坦克独自出击路线
blue_tank_detect_path = [
							[1926, 2026, 2025, 2024, 1924, 1925, 1926],
							[1926, 1925, 1825, 1724, 1825, 1925, 1926]
						]
